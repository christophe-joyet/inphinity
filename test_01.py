...
#=============================================================
#chart - Number of phages and Number of Bacterium total in DB Inphinity
...
#=============================================================
#chart how many differents phages and how many differents bacteries
...
axs[0,0].set_title("Bacteries / Phages in couples")
wedges, texts, autotexts = axs[0,0].pie(data, autopct='%.0f%%')
axs[0,0].legend(wedges, data_name,
          title="Bacteries / Phages in couples",
          loc="center left",
...
for couple in list_couple:
  if not couple.validity in validity:
